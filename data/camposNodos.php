...
$camposNodos[] = ['nombreDB'=>'nombre','nombreMostrar'=>'Nombre', 'orden'=>2, 'mostrarListado'=>'si', 'mostrarEditar'=>'si', 'mostrarReporte'=>'si', 'mostrarExcel'=>'si', 'tam'=>2.2, 'especial'=>'no', 'formato'=>''];///nombre
$camposNodos[] = ['nombreDB'=>'tipo','nombreMostrar'=>'Tipo', 'orden'=>3, 'mostrarListado'=>'si', 'mostrarEditar'=>'si', 'mostrarReporte'=>'si', 'mostrarExcel'=>'si', 'tam'=>2.2, 'especial'=>'no', 'formato'=>''];///tipo
...
$camposNodos[] = ['nombreDB'=>'ip','nombreMostrar'=>'IP', 'orden'=>6, 'mostrarListado'=>'si', 'mostrarEditar'=>'si', 'mostrarReporte'=>'si', 'mostrarExcel'=>'si', 'tam'=>2, 'especial'=>'no', 'formato'=>''];///ip
