...
$camposAlarmas[] = ['nombreDB'=>'dia','nombreMostrar'=>'Fecha', 'orden'=>2, 'mostrarListado'=>'si', 'mostrarEditar'=>'si', 'mostrarReporte'=>'si', 'mostrarExcel'=>'si', 'tam'=>2, 'especial'=>'no', 'formato'=>''];///fecha
...
$camposAlarmas[] = ['nombreDB'=>'compound','nombreMostrar'=>'Compound', 'orden'=>5, 'mostrarListado'=>'si', 'mostrarEditar'=>'si', 'mostrarReporte'=>'si', 'mostrarExcel'=>'si', 'tam'=>1.6, 'especial'=>'no', 'formato'=>''];///compound
$camposAlarmas[] = ['nombreDB'=>'tipoAID','nombreMostrar'=>'AID', 'orden'=>6, 'mostrarListado'=>'si', 'mostrarEditar'=>'si', 'mostrarReporte'=>'si', 'mostrarExcel'=>'si', 'tam'=>1.2, 'especial'=>'no', 'formato'=>''];///tipo aid
$camposAlarmas[] = ['nombreDB'=>'tipoAlarma','nombreMostrar'=>'Alarma', 'orden'=>7, 'mostrarListado'=>'si', 'mostrarEditar'=>'si', 'mostrarReporte'=>'si', 'mostrarExcel'=>'si', 'tam'=>1.4, 'especial'=>'no', 'formato'=>''];///tipo alarma
...
$camposAlarmas[] = ['nombreDB'=>'afectacionServicio','nombreMostrar'=>'Afectaci&oacute;n', 'orden'=>9, 'mostrarListado'=>'si', 'mostrarEditar'=>'no', 'mostrarReporte'=>'si', 'mostrarExcel'=>'si', 'tam'=>2.3, 'especial'=>'no', 'formato'=>''];///afectacion
$camposAlarmas[] = ['nombreDB'=>'ubicacion','nombreMostrar'=>'Ubicaci&oacute;n', 'orden'=>11, 'mostrarListado'=>'si', 'mostrarEditar'=>'si', 'mostrarReporte'=>'no', 'mostrarExcel'=>'no', 'tam'=>1.6, 'especial'=>'no', 'formato'=>''];///ubicacion
...
$camposAlarmas[] = ['nombreDB'=>'filtroAID','nombreMostrar'=>'Filtro AID', 'orden'=>17, 'mostrarListado'=>'si', 'mostrarEditar'=>'si', 'mostrarReporte'=>'no', 'mostrarExcel'=>'no', 'tam'=>1, 'especial'=>'no', 'formato'=>''];///filtro AID
...
$camposAlarmas[] = ['nombreDB'=>'fechaCarga','nombreMostrar'=>'Fecha de Carga', 'orden'=>22, 'mostrarListado'=>'no', 'mostrarEditar'=>'si', 'mostrarReporte'=>'no', 'mostrarExcel'=>'no', 'tam'=>1, 'especial'=>'no', 'formato'=>''];///fecha carga
$camposAlarmas[] = ['nombreDB'=>'estado','nombreMostrar'=>'Estado', 'orden'=>18, 'mostrarListado'=>'si', 'mostrarEditar'=>'si', 'mostrarReporte'=>'no', 'mostrarExcel'=>'no', 'tam'=>1, 'especial'=>'no', 'formato'=>''];///estado
$camposAlarmas[] = ['nombreDB'=>'causa','nombreMostrar'=>'Causa', 'orden'=>23, 'mostrarListado'=>'si', 'mostrarEditar'=>'si', 'mostrarReporte'=>'si', 'mostrarExcel'=>'si', 'tam'=>3, 'especial'=>'no', 'formato'=>''];///causa
