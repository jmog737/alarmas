    ...
    <?php
      ...
      if ($seguir){
        ...
        if ($mostrarError) {
          ...
          /// Armo la consulta
          $consulta = "select * from alarmas where archivo='".$_SESSION['archivo']."' order by dia desc, hora desc";
          
          $datos = hacerSelect($consulta);
                ...
                if ($camposAlarmas[$key]['mostrarListado'] === 'si'){
                  ...
                  switch ($indice){
                    ...
                    case 'estado':  if ($fila['estado'] === 'Sin procesar'){
                                    ...
                                    break;                  
                    case 'accion':  $j = $i - 1;
                                    echo "<td><a href='editarAlarma.php?idalarma=".$idalarma."&id=".$j."'>Editar</a></td>";
                                    break;         
